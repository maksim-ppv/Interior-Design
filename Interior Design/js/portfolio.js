...
$(document).ready(function() {
    $(".controls-price__panel").on('click', '.controls-price__link', function() {
        ...
        const designInterier = document.querySelectorAll('.design_interier');
        const renovationDecor = document.querySelectorAll('.renovation_and_decor');
        const commercialObjects = document.querySelectorAll('.commercial_objects');
        ...
        if( newImage == 1){
            designInterier.forEach(item=>{
                item.style.display='';
            })
        };
        if( newImage == 2){
            renovationDecor.forEach(item=>{
                item.style.display='';
            })
        };
        if( newImage == 3){
            commercialObjects.forEach(item=>{
                item.style.display='';
            })
        };
        $(".project__img-decision").removeClass("show_rel");    
        $(".project__img-decision").eq(newImage).addClass("show_rel");
