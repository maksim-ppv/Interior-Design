...
function init() {
    ...
    var placemark = new ymaps.Placemark(myMap.getCenter(), {
        ...
        // balloonContentBody: '<img src="img/footer/map.svg" height="10" width="14"> Адрес',
        // balloonContentFooter: '<span class="feedback-slider__content-name feedback-slider__content-info">Алексей</span><span class="feedback-slider__content-local feedback-slider__content-info">г.Минск, ул. Жасминовая 6</span>',
    }, {
...
$(document).ready(function() {
    $(".controls-price__panel").on('click', '.controls-price__link', function() {
        ...
        $(".portfolio-content").eq(newImage).addClass("show_rel");
